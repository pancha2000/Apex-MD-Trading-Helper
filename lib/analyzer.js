...
// ✅ NEW precision tools
const { calculateStochRSI, calculateBollingerBands, detectMTFOrderBlocks, calculateSmartTPs, calculateSmartSL, checkMTFRSIConfluence, detectVolumeNodes, getSessionQuality, checkCandleCloseConfirmation } = require('./indicators');
...
async function run14FactorAnalysis(coin, timeframe = '15m') {
    ...
    return {
        ...
        stochRSI, bbands, mtfOB,
        score: finalScore, maxScore: 21, reasons: finalReasons,
