...
// ✅ NEW precision tools
const { calculateStochRSI, calculateBollingerBands, detectMTFOrderBlocks, calculateSmartTPs, calculateSmartSL } = require('./indicators');
...
async function run14FactorAnalysis(coin, timeframe = '15m') {
    ...
    return {
        ...
        score: finalScore, maxScore: 17, reasons: finalReasons  // 14 + StochRSI + BB + MTF OB
    };
}
