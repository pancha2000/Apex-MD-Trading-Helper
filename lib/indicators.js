...
function calculateADX(candles, period = 14) {
    ...
    return {
        value: parseFloat(adx.toFixed(2)), isStrong: adx >= 25,
...
function checkHarmonicPattern(candles) {
    ...
    // Bearish PRZ: price rallying INTO resistance = minL + fib extension (above current)
    let swingDown = maxH - minL;
    let b_fib886 = minL + (swingDown * 0.886); // resistance zone above
    let b_fib786 = minL + (swingDown * 0.786); // resistance zone above
