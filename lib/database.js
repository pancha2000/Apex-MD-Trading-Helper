...
// 🚀 අලුතින් එකතු කළ Trade Tracker Schema එක 🚀
const tradeSchema = new mongoose.Schema({
    userJid: { type: String, required: true },
    coin: { type: String, required: true },
    type: { type: String, default: 'future' }, // spot or future
...
const Trade = mongoose.model('Trade', tradeSchema); // අලුත් Model එක
...
// 🚀 අලුතින් එකතු කළ Trade Functions 🚀
